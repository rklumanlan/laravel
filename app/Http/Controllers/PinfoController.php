...
use App\Http\Requests\UpdatePinfoRequest;
...
class PinfoController extends Controller {
	...
	public function edit($id2)
	{
		...
		$pinfo2 = User::find($id)->pinfo()->where('id', '=', $id2)->first();
	 ...
	 * @return Response
	 */
	public function update(UpdatePinfoRequest $request, $id)
	{
		Pinfo::where('id', '=', Auth::id())->update($request->except('_method','_token','update_pinfo'));

		flash()->overlay($this->message('Personal Information','edit'),'Success!');
